      ...
      .then((resp) => {
        ...
        resp.docs.forEach((x) => {
          if (options == 'Finalizado') {
            ...
            if (
              x.data().status === 'Cancelado' ||
              x.data().status === 'Finalizado'
            ) {
              filteredDocs.push(x.data());
            }
          }
        ...
        <div className="history-top">
          ...
          <div className="filter-area">
            <select className="filter-by-type" onChange={prevent}>
              <option className="f-type" selected-disabled>
                Filtros
              </option>
              <option value="Todos" className="f-type">
                Todos
              </option>
              <option value="Finalizado" className="f-type">
                Finalizados
              </option>
              <option value="Cancelado" className="f-type">
                Cancelados
              </option>
            </select>
          </div>
